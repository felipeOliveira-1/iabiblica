...
st.markdown("""
Este é um aplicativo de teste ALPHA1 que utiliza o modelo mais avançado de Inteligencia Artificial, capaz de oferecer conhecimento, sabedoria e ensinamentos Bíblicos.
